                    ...
                    <div className="flex items-center">
                        ...
                        <div className="block md:hidden">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <Link to={"../../"} className=" hover:bg-red-500 hover:text-white  text-red-500 px-3 py-2 rounded-md text-sm font-sans">
                                    Log out
                                </Link>
                            </div>
                ...
                {(ref) => (
                    <div className="md:block" id="mobile-menu">
                        <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                                ...
                                <Link to={"../../"} className="hover:bg-red-500 hover:text-white  text-red-500 block px-3 py-2 rounded-md text-sm font-sans">
                                    Logout
                                </Link>
