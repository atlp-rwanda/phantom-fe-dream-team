...
function Landingpage() {
    return (
        <div>
           ...
           <div className='text-center mt-40 ml px-20 lg:mt-10'>
           ...
           <button className='mt-10 lg:mt-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded xl:text-xs  lg:text-base md:text-xs py-1 px-3 sm:text-xs xs:text-xs'>Read More</button>
