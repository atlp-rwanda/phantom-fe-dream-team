...
function Services() {
    return ( 
        ...
        <div className="bg-[#fafaf9] flex flex-col items-center p-20  mb-10 xs:my-10 sm:my-10 md:my:10 lg:my-10    rounded-xl">
        ...
        <div className="bg-[#fafaf9]  flex flex-col items-center mb-10   p-20 xs:my-10 sm:my-10 md:my:10 lg:my-10   rounded-xl ">
