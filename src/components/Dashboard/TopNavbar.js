...
function TopNavbar({ goto }) {
  ...
  return (
    ...
    <div className='flex flex-nowrap  bg-white row-auto items-center border-2 border-solid border-white border-b-black w-full mt-5 sm:h-20 sm:flex-col sm:m-5'>
      ...
      <div className="flex sm:mt-10">
        ...
        <div className="relative ml-2 sm:mt-[-40px]">
          ...
          <input type="search" name="q" className="py-2 text-sm text-white border-2 border-solid rounded-md  focus:outline-none focus:bg-white focus:text-gray-900 sm:w-[90%] ml-[10px]"></input>
        </div>
