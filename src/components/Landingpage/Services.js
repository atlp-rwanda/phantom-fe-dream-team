    ...
    return (
        <div>
            ...
            <div className="bg-blue-800 pb-20" >
                ...
                <h1 className="text-center mr-60  py-5  text-3xl text-white font-bold ml-40  lg:text-2xl  md:text-xl  sm:text-base xs:text-base   " >How it works</h1>
                ...
                <div className="flex flex-row  space-x-10 lg:space-x-0  md:flex-col sm:space-x-0 mx-5">
                    <div className="bg-[#fafaf9] w-1/3 text-blue-500 flex flex-col items-center p-5  mb-5 md:w-full xs:my-5 rounded-xl">
                        ...
                        <h3 className="text-2xl text-blue-800 font-bold mt-10">Step1</h3>
                        <p className="text-base mt-10   xl:text-base lg:text-base md:text-base sm:text-xs xs:text-xs">Click On  Track Bus</p>
