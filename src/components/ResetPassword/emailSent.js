...
export default function emailSent() {
  return (
    ...
    <div className='flex justify-center text-center mt-40 mb-20 lg:flex md:flex'>
     ...
     <p className='font-bold mt-5'>Done</p>
     <div className='flex justify-center'>
     <img src={sent} alt='sent'/>
     </div>
         <p className='mt-10 text-left ml-20 p-2 xs:text-center'>Password reset successfully</p>
         <div className='mt-5 md:mb-10 sm:mb-10 lg:mb-10 '>
         <Link to="/Signin">
             <button className='bg-blue-700 text-white py-2.5 px-8 rounded-lg'>Login</button></Link>
         </div>
     </div>
    </div>
    </form>
