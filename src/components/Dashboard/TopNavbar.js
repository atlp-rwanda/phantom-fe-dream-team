              ...
              <div className="flex sm:mt-10">
                  ...
                  <div className="relative ml-2 sm:mt-[-40px]">
                    <span className="absolute inset-y-0 left-0 flex items-center pl-2">
                        ...
                        <input type="search" name="q" className="py-2 px-8 text-sm text-white border-2 border-solid rounded-md  focus:outline-none focus:bg-white focus:text-gray-900 sm:w-[90%] ml-[10px]"></input>
                  </div>
