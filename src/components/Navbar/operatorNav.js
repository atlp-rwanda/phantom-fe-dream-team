                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <a
                                        href="#"
                                        className=" hover:bg-blue-700 text-red-400 px-3 py-2 rounded-md text-sm font-sans"
                                    >
                                        Log out
                                    </a>
                                </div>
                    ...
                    {(ref) => (
                        <div className="md:hidden" id="mobile-menu">
                            <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                                ...
                                <a
                                    href="#"
                                    className=" hover:bg-red-500 hover:text-white text-red-500 block px-3 py-2 rounded-md text-sm font-sans"
                                >
                                   Log out
                                </a>
                            </div>
