        ...
        <div>
            ...
            <div className='flex  flex-row  mt-20 py-10 xs:flex-col-reverse md:mt-10'>
                <div className='text-center mt-20 xs:m-4 px-20 lg:mt-10 '>
                    ...
                    <p className='text-serif py-10 text-base text-blue-500 text-xl xl:text-base lg:text-base md:text-base sm:text-xs xs:text-xs xs:mt-2 xs:py-2' >Choose Your Route Track your bus live .</p>
